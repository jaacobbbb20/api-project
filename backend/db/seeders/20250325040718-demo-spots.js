    ...
    const spots = [
      {
        ...
        description:
          "Spacious, and wide open space in the heart of the Dark Oak Forest",
        price: 200,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        name: "Lakeside House",
        description:
          "Spacious lakeside house with a place to get in your kayak, watch the sunset, and have fun!",
        price: 180,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
